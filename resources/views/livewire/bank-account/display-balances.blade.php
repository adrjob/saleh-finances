<x-manager-action-section>
    ...
    <x-slot name="content">
        ...
        <x-jet-action-message class="mr-3" on="created">
            <div class="font-medium text-green-600">The account balance has been recorded.</div>
            <br>
        </x-jet-action-message>

        <x-jet-action-message class="mr-3" on="deleted">
            <div class="font-medium text-green-600">The recorded account balance has been deleted.</div>
            <br>
        </x-jet-action-message>
        ...
        <x-jet-dialog-modal wire:model="createBalance">
            ...
            <x-slot name="content">
                <div class="col-span-6 sm:col-span-4" x-on:create-balance.window="setTimeout(() => $refs.captured.focus(), 250)">
                    <x-jet-label for="captured" value="Date"/>
                ...
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="value" value="Amount"/>

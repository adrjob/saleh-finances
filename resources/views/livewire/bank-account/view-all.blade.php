<x-manager-action-section>
    <x-slot name="content">
        ...
        <x-jet-action-message class="mr-3" on="saved">
            <div class="font-medium text-green-600">Bank account has been saved.</div>
            <br>
        </x-jet-action-message>

        <x-jet-action-message class="mr-3" on="deleted">
            <div class="font-medium text-green-600">Bank account has been deleted.</div>
            <br>
        </x-jet-action-message>
        ...
        <x-jet-dialog-modal wire:model="editingBankAccount">
            ...
            <x-slot name="content">
                ...
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="accountNumber" value="Location"/>
